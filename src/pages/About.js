...
const About = () => {
    ...
    useEffect(() => {
        ...
        const getTopSeller = async () => {
            try {
                const res = await axios.get("http://194.163.186.157:63250/api/realtors/topseller", config);
    ...
    useEffect(() => {
        ...
        const getRealtors = async () => {
            try {
                const res = await axios.get("http://194.163.186.157:63250/api/realtors/", config);
